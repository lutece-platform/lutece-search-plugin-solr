...
--
INSERT INTO solr_fields (id_field,name,label,type,description,is_facet,enable_facet,is_sort,enable_sort,default_sort) VALUES 
...
INSERT INTO solr_fields (id_field,name,label,type,description,is_facet,enable_facet,is_sort,enable_sort,default_sort) VALUES 
(4,'score','Score','','Pertinance du résultat',false,false,true,true,true);
